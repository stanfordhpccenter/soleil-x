...
return {
  ...
  -- Grid Options --
  xnum = 4, -- number of cells in the x-direction
  ynum = 4, -- number of cells in the y-direction
  znum = 4,  -- number of cells in the z-direction
