...
###############################################################################
# Get a section of the domain between two x locations
###############################################################################

def crop_x_section(input_source, clip_start_point, clip_stop_point):
...
# you can change what chuck in the x direction you get by changing these values
...
for variable_name in fluid_variable_names:
   ...
   # save screenshot
   screenshot_filename = os.path.join(out_dir,'outlet_clip_fluid_{}_vs_time.png'.format(variable_name))
...
for variable_name in particle_variable_names:
   ...
   # save screenshot
   screenshot_filename = os.path.join(out_dir,'outlet_clip_particle_{}_vs_time.png'.format(variable_name))
   SaveScreenshot(screenshot_filename,
                  chartView,
                  ImageResolution=[view_size_x, view_size_y],
                  CompressionLevel='0')
